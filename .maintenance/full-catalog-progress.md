...
- NUS12新项（8法律衔接、AI数学双学位、社会工作MPH、2个SCALE本硕框架）197事实、35源URL＋SHA已通过root独立复核；原128与profile保持。逐读7合作正文、2完整课程PDF文本和2SCALE专页，Chrome目视SWKp1/AIMathp2；另取得Registrar研究生费p2–4，目视p3国际列，明确普通MPH27950／99800按年含GST，CDP总费不推算。已修4条纯NUS语言、8联合地点、NYU排名提交责任和中文条目类别。待数据层合入；另3邓迪方向与KCL40临床健康条目只写scratch。
