...
详细专业资料覆盖英国、澳大利亚、新加坡 6 所大学的 24 个本科项目。其余学校标注“专业详情待收录”。资料核验：2026-09-12。本批新增工程与经济方向，每校 4 个专业；详情页含校区、授课语言、入学条件、申请渠道与截止日期、学费与资助、毕业生情况。入学年、学费年、申请批次、毕业调查年分别记录；缺少的资料不推算。QS 名次规则和覆盖范围见[数据说明](docs/about/catalog-data.md)。
