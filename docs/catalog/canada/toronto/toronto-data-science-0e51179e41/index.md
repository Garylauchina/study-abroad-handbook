...
<p class="catalog-fact"><strong>所属学科课程内容：</strong>数据科学以计算机、统计和数学为基础，研究从数据学习的方法，并讨论数据收集使用的社会、文化、法律及伦理问题。</p>
<p class="fact-sources"><a href="#source-p-toronto-detail-058">官方依据</a></p>
...
- [官方项目页面或项目所在目录](https://artsci.calendar.utoronto.ca/section/Data-Science)
- [官方目录](https://www.utoronto.ca/academics/undergraduate-programs)

<div class="catalog-source" id="source-p-toronto-detail-058"><div><a href="https://artsci.calendar.utoronto.ca/section/Data-Science">多伦多大学官方资料：toronto-detail-058 ↗</a><p>所引课程内容、入学路径、年度政策及范围说明</p><small>核验 2026-09-12</small></div></div>
