...
<p><strong>官方名称：</strong>First Nations and Endangered Languages</p>

<p><strong>授予学位 / 项目类型：</strong>Bachelor of Arts</p>

<p><strong>目录适用期：</strong>官网当前目录；未标明确入学年度，核对于2026-09-12</p>

<p class="catalog-fact"><strong>项目内容：</strong>学习濒危语言、文化和知识体系的记录、保存、复兴与恢复方法及程序。</p>
...
- [官方项目页面或项目所在目录](https://you.ubc.ca/programs/first-nations-endangered-languages/)
- [官方目录](https://you.ubc.ca/programs/)

<div class="catalog-source" id="source-p-program"><div><a href="https://you.ubc.ca/programs/">UBC官方本科项目资料：First Nations and Endangered Languages ↗</a><p>公开完整programsListData中的培养内容、项目类型及官方项目入口</p><small>核验 2026-09-12</small></div></div>
