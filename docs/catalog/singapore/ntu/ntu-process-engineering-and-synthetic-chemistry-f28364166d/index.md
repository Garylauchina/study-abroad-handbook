---
title: "南洋理工大学 · Process Engineering and Synthetic Chemistry"
...
<nav class="catalog-crumbs" aria-label="浏览路径"><a class="" href="/study-abroad-handbook/">大学与专业</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/singapore/">新加坡</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/singapore/ntu/">南洋理工大学</a> <span aria-hidden="true">/</span> <span aria-current="page">Process Engineering and Synthetic Chemistry</span></nav>
...
<p class="catalog-fact"><strong>目录身份：</strong>官方目录所列学位／路径：Bachelor of Engineering Science in Process Engineering and Synthetic Chemistry。入学年份与是否接受特定身份须结合招生规则；目录列名本身不等于当前开放申请。</p>
<p class="fact-sources"><a href="#source-p-ASREN-03cee2ffd0d8d5">官方依据</a></p>

<p class="catalog-fact"><strong>项目学制：</strong>官网项目结构栏列4年；减免、加速或海外阶段的个别选项须另核。</p>
<p class="fact-sources"><a href="#source-p-ASREN-03cee2ffd0d8d5">官方依据</a></p>

<p class="catalog-fact"><strong>培养内容举例：</strong>课程／培养说明涉及人工智能、实验训练、实习、材料、化学。这里只概述页面已明列的部分内容，不作为完整必修表。</p>
<p class="fact-sources"><a href="#source-p-ASREN-03cee2ffd0d8d5">官方依据</a></p>

## 入学条件 {#admissions}

<p class="catalog-fact"><strong>专业科目／材料要求：</strong>国际及其他资格须有高中数学及高中化学。</p>
<p class="fact-sources"><a href="#source-p-ASREN-03cee2ffd0d8d5">官方依据</a></p>
...
<div class="catalog-source" id="source-p-ASREN-03cee2ffd0d8d5"><div><a href="https://www.ntu.edu.sg/cceb/admissions/detail/bachelor-of-engineering-science-with-double-majors-in-process-engineering-and-synthetic-chemistry#programme">Process Engineering and Synthetic Chemistry — NTU官方项目资料 ↗</a><p>项目身份、学制、课程内容、科目条件及职业方向</p><small>核验 2026-09-12</small></div></div>
