...
<nav class="catalog-crumbs" aria-label="浏览路径"><a class="" href="/study-abroad-handbook/">大学与专业</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/hong-kong/">中国香港</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/hong-kong/cuhk/">香港中文大学</a> <span aria-hidden="true">/</span> <span aria-current="page">计算机科学与工程（共同招生入口）</span></nav>
...
<p><strong>授予学位 / 项目类型：</strong>本科共同入口（后分 BEng Computer Engineering / BSc Computer Science）</p>

<p><strong>目录适用期：</strong>Programme / Stream List (2026 Entry)</p>

<p><strong>目录条目类别：</strong>common_admission_scheme</p>

<p><strong>申请路径：</strong>共同入口，大一后分BEng计算机工程或BSc计算机科学；课程/GPA和分配容量有条件。</p>

<p><strong>目录状态：</strong>listed_current</p>

<p class="catalog-fact"><strong>课程内容：</strong>学系共同入口：第一年后在计算机工程和计算机科学间分流；前者强化硬件嵌入式系统，后者偏软件和算法。</p>
...
<p class="catalog-fact"><strong>主修分流：</strong>学生完成第一年后在计算机工程与计算机科学间申报主修；不能把网页对优秀HKDSE学生的首选保证套用于全体高考学生。</p>
<p class="fact-sources"><a href="#source-p-cuhk-detail-cd110478b38c23989a97">官方依据</a></p>
...
- [官方项目页面或项目所在目录](https://admission.cuhk.edu.hk/programme/bcsen/)
