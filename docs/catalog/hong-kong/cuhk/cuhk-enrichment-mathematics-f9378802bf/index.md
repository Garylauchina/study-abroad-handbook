...
<nav class="catalog-crumbs" aria-label="浏览路径"><a class="" href="/study-abroad-handbook/">大学与专业</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/hong-kong/">中国香港</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/hong-kong/cuhk/">香港中文大学</a> <span aria-hidden="true">/</span> <span aria-current="page">数学精研</span></nav>

<p class="catalog-eyebrow">香港中文大学 · 本科 · 数学与统计</p>

# 数学精研

<p class="program-title-en">Enrichment Mathematics</p>
...
<p><strong>官方名称：</strong>Enrichment Mathematics</p>

<p><strong>授予学位 / 项目类型：</strong>Bachelor of Science（数学精研方向）</p>

<p><strong>目录适用期：</strong>Programme / Stream List (2026 Entry)</p>

<p><strong>目录条目类别：</strong>programme_or_stream</p>

<p><strong>申请路径：</strong>高考生先经理学修读对应主修，最快两个学年后按遴选规则申报精研；2027条件待核。</p>

<p><strong>目录状态：</strong>listed_current</p>

<p class="catalog-fact"><strong>课程内容：</strong>数学精研覆盖纯数学与应用数学，可结合计算、统计和计算机研究或应用。</p>
<p class="fact-sources"><a href="#source-p-cuhk-detail-5da9314c3e72fdb8754e">官方依据</a></p>

<p class="catalog-fact"><strong>学制：</strong>本页2026课程信息列标准修读期4年；高年级衔接年数不可当作高中直入完整本科年数。</p>
<p class="fact-sources"><a href="#source-p-cuhk-detail-5da9314c3e72fdb8754e">官方依据</a></p>

<p class="catalog-fact"><strong>2026数学课程与先后关系：</strong>2026精研入读建议修荣誉大学数学、数学方法、线性代数和集合论，之后学习高等微积分、线性代数II、数学分析、代数结构及复变函数；毕业须完成项目或研讨课。修课须逐门满足先修，并不是每门荣誉课都强制。</p>
<p class="fact-sources"><a href="#source-p-cuhk-sup-math-enrichment-2026">官方依据</a></p>
...
<p class="catalog-fact"><strong>内地高考的精研路线：</strong>当前内地高考目录注13要求先经理学选定相应主修、通过遴选并符合学系规定，最快在两个学年后申报精研；不能直接套JUPAS数学精研/理论物理精研的一年级独立入口。</p>
<p class="fact-sources"><a href="#source-p-cuhk-sup-gaokao-list">官方依据</a></p>

<p class="catalog-fact"><strong>精研直入与普通数学生的区别：</strong>精研直入者完成方向课程即可按相应规定毕业；普通数学学生转选精研另须满足GPA条件。当前网页提及高年级荣誉课2027/28由B-改B仅属可能调整，不在本条写成已生效门槛。</p>
<p class="fact-sources"><a href="#source-p-cuhk-sup-math-enrichment-2026">官方依据</a></p>
...
- [官方项目页面或项目所在目录](https://admission.cuhk.edu.hk/programme/mathn/)
- [官方目录](https://admission.cuhk.edu.hk/programmes/list/)

<div class="catalog-source" id="source-p-cuhk-detail-5da9314c3e72fdb8754e"><div><a href="https://admission.cuhk.edu.hk/programme/mathn/">cuhk 官方本科资料：detail-5da9314c3e72fdb8754e ↗</a><p>本条学术/英语/申请/资助/费用事实及适用范围</p><small>核验 2026-09-12</small></div></div>
...
<div class="catalog-source" id="source-p-cuhk-sup-gaokao-list"><div><a href="https://admission.cuhk.edu.hk/sc/application/mainland-gaokao/list/">专业一览表 - 香港中文大学本科招生 ↗</a><p>注13及两精研行</p><small>核验 2026-09-13</small></div></div>
<div class="catalog-source" id="source-p-cuhk-sup-math-enrichment-2026"><div><a href="https://www.math.cuhk.edu.hk/student-centre/academic-advice/GenReq-Enrichment-2026-27">General Requirements at University, Faculty, Programme levels for Enrichment Mathematics entrants 2026 | CUHK Mathematics ↗</a><p>Tables A/C 与Honours Courses、Capstone说明</p><small>核验 2026-09-13</small></div></div>
