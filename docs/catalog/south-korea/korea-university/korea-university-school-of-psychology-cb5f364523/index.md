---
title: "高丽大学 · School of Psychology"
...
<p class="catalog-fact"><strong>课程内容示例：</strong>该本科课程区列示的学习内容包括：微积分、线性代数、概率统计、编程、算法、人工智能。这是页面中课程与课程说明的摘取示例，含可能的选修或基础课；本轮未逐项确认全部必修、先修链及2027修读规则。</p>
<p class="fact-sources"><a href="#source-p-ASREN-8f12b5591cd3f7">官方依据</a></p>
...
<div class="catalog-source" id="source-p-ASREN-8f12b5591cd3f7"><div><a href="https://psy.korea.edu/UnderGraduate/Curriculum">官方本科课程结构 ↗</a><p>本科课程区中明确出现的内容示例；未把这些示例视为完整必修表</p><small>核验 2026-09-12</small></div></div>
