---
title: "台湾大学 · Department of Information Management"
...
<p class="catalog-fact"><strong>课程内容示例：</strong>该本科课程区列示的学习内容包括：微积分、概率统计、编程、数据结构、算法、操作系统。这是页面中课程与课程说明的摘取示例，含可能的选修或基础课；本轮未逐项确认全部必修、先修链及2027修读规则。</p>
<p class="fact-sources"><a href="#source-p-ASREN-778f1c6fd64f46">官方依据</a></p>
...
<div class="catalog-source" id="source-p-ASREN-778f1c6fd64f46"><div><a href="https://management.ntu.edu.tw/en/IM/curriculum/undergraduate">官方本科课程结构 ↗</a><p>本科课程区中明确出现的内容示例；未把这些示例视为完整必修表</p><small>核验 2026-09-12</small></div></div>
