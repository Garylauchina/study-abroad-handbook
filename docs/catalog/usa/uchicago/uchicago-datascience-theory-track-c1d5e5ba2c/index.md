...
<nav class="catalog-crumbs" aria-label="浏览路径"><a class="" href="/study-abroad-handbook/">大学与专业</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/">美国</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/uchicago/">芝加哥大学</a> <span aria-hidden="true">/</span> <span aria-current="page">数据科学—理论方向</span></nav>

<p class="catalog-eyebrow">芝加哥大学 · 本科 · 计算机</p>

# 数据科学—理论方向

<p class="program-title-en">Data Science — Theory Track</p>
...
<strong>所属课程或升读路径</strong><ul><li><a class="" href="/study-abroad-handbook/catalog/usa/uchicago/uchicago-data-science-2efd7408b2/">数据科学（BA／BS）</a></li></ul><p>方向、组合与升读阶段不等于独立招生项目，具体资格见各条目。</p></nav>
...
<p><strong>官方名称：</strong>Data Science — Theory Track</p>
...
<p><strong>所属学位：</strong>B.A. / B.S.</p>

<p><strong>申请路径：</strong>先获College录取、申报父主修，再按方向要求制定在读课程计划；不是额外独立高中申请学位。</p>

<p><strong>目录状态：</strong>现行在读培养方案</p>

<p>所属主修：数据科学（BA／BS）；本条为内部方向或BA/BS学位路径，不是额外高中招生入口。</p>

<p class="catalog-fact"><strong>所选方向与父学位：</strong>用STAT25100替代DATA21100、MATH19620或STAT24300替代DATA21200，并须将STAT24400与24500成套修完，替代DATA21300及DATA23100；另外至少一门机器学习选修。它是BA/BS的课程替代方向，不再额外授予理论学位。</p>
<p class="fact-sources"><a href="#source-p-UCHG-datascience">官方依据</a></p>

<p class="catalog-fact"><strong>记录层级：</strong>本条是数据科学（BA／BS）内部的理论方向。独立条目便于查询，并不等于大学另外招收一届新生或多授予一个学位。</p>
<p class="fact-sources"><a href="#source-p-UCHG-datascience">官方依据</a></p>

<p class="catalog-fact"><strong>学位与培养结构：</strong>BA为15课1500 units（另有Core微积分200）：数据科学4课、Data Science Clinic两季度、机器学习1、计算机2、数学统计3、选修3。BS为18课1800 units，在BA基础增加一个自然/社会/人文学科内连贯的3门20000级以上应用领域课程，不能由统计/计算机/数学方法课充当；BS还需一门选修属于机器学习。Clinic为真实客户团队项目，不是就业保证。</p>
<p class="fact-sources"><a href="#source-p-UCHG-datascience">官方依据</a> · <a href="#source-p-UCHG-curriculum">官方依据</a></p>

<p class="catalog-fact"><strong>全学位要求与年度：</strong>父主修开设B.A. / B.S.；按2026/27目录，通常4年、全学位至少4200 units，至少3800需实际修课；Core、语言能力、驻校和GPA等共同要求同时适用。2027入学后的规则需核相应目录，不能把主修课程units视为全学位学分。</p>
...
<p class="catalog-fact"><strong>专业在读先修与学业要求：</strong>申报主修不要求辅修所用的consent form，建议先咨询本科副主任。所有计入专业的课程至少C，至少一半学分由本校课程取得；专业GPA3.7可获荣誉。多数CMSC进阶课程须CMSC14200，通常不能未经分班考核豁免。理论与计算路径是课程替代方案，不是额外授予的学位。</p>
<p class="fact-sources"><a href="#source-p-UCHG-datascience">官方依据</a> · <a href="#source-p-UCHG-programsofstudy">官方依据</a></p>
...
- [官方项目页面或项目所在目录](http://collegecatalog.uchicago.edu/thecollege/datascience/)
- [官方目录](http://collegecatalog.uchicago.edu/thecollege/datascience/)

<div class="catalog-source" id="source-p-UCHG-datascience"><div><a href="http://collegecatalog.uchicago.edu/thecollege/datascience/">数据科学（BA／BS）本科培养要求（2026/27） ↗</a><p>本专业学位、课程结构、在读申报与学业要求；不作为2027新生统一录取分数</p><small>核验 2026-09-13</small></div></div>
