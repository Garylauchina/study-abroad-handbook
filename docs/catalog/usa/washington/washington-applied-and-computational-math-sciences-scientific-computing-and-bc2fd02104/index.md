---
title: "华盛顿大学 · 应用与计算数学科学：科学计算与数值分析"
...
<nav class="catalog-crumbs" aria-label="浏览路径"><a class="" href="/study-abroad-handbook/">大学与专业</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/">美国</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/washington/">华盛顿大学</a> <span aria-hidden="true">/</span> <span aria-current="page">应用与计算数学科学：科学计算与数值分析</span></nav>

<p class="catalog-eyebrow">华盛顿大学 · 本科 · 计算机</p>

# 应用与计算数学科学：科学计算与数值分析

<p class="program-title-en">Applied and Computational Math Sciences: Scientific Computing and Numerical Analysis</p>
...
<p><strong>官方名称：</strong>Applied and Computational Math Sciences: Scientific Computing and Numerical Analysis</p>
...
<p class="catalog-fact"><strong>课程与学分：</strong>共同数学编程核心之外，方向55—56学分包括概率、数学建模、微积分基础物理、数据编程、数值分析和AMATH481—483科学计算系列，以及至少10学分认可选修。侧重复杂数学模型的数值算法与计算机实现。</p>
<p class="fact-sources"><a href="#source-p-UW26CAT-9e20c21065b90c">官方依据</a></p>

<p class="catalog-fact"><strong>授位与目录层级：</strong>Bachelor of Science；官方项目名称为 Applied and Computational Math Sciences: Scientific Computing and Numerical Analysis。这是学士项目中的具名选项；不可把选项与其母学位再累计为两个独立学位。 归属UW Seattle目录，非Bothell/Tacoma项目。</p>
<p class="fact-sources"><a href="#source-p-UW26CAT-9e20c21065b90c">官方依据</a></p>
...
- [官方项目页面或项目所在目录](https://uw.edu/students/gencat/program/S/AppliedandComputationalMathSciences-994.html#credential-67e1c58f223c2c2a10978169)
- [官方目录](https://www.washington.edu/students/gencat/degree_programs.html)

<div class="catalog-source" id="source-p-UW26CAT-9e20c21065b90c"><div><a href="https://uw.edu/students/gencat/program/S/AppliedandComputationalMathSciences-994.html#credential-67e1c58f223c2c2a10978169">UW Seattle官方本科目录：Bachelor of Science degree with a major in Applied and Computational Math Sciences: Scientific Computing and Numerical Analysis ↗</a><p>本专业/具名方向的学位身份、课程结构、学分及院系与项目专属先修；目录未逐条标出2027招生年。</p><small>核验 2026-09-13</small></div></div>
