...
<p class="catalog-fact"><strong>目录身份：</strong>官方目录收录 Biology（本科项目（学位名称尚未核实））。本轮尚未完成该独立项目课程、费用及毕业去向的逐项核对；学校通用规则另列。</p>
...
- [官方项目页面或项目所在目录](https://lsa.umich.edu/lsa/academics/majors-minors.html#biology-maj)
- [官方目录](https://admissions.umich.edu/academics-majors/majors-degrees)

<div class="catalog-source" id="source-p-USBENR-fc23bbf18aa15f"><div><a href="https://admissions.umich.edu/academics-majors/majors-degrees">Biology — 官方本科目录 ↗</a><p>专业名称与目录入口；本轮未取得独立课程完整详情</p><small>核验 2026-09-12</small></div></div>
