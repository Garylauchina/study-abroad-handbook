---
title: "密歇根大学安娜堡分校 · Learning, Equity, and Problem Solving for the Public Good (LEAPS)"
...
<nav class="catalog-crumbs" aria-label="浏览路径"><a class="" href="/study-abroad-handbook/">大学与专业</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/">美国</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/michigan/">密歇根大学安娜堡分校</a> <span aria-hidden="true">/</span> <span aria-current="page">Learning, Equity, and Problem Solving for the Public Good (LEAPS)</span></nav>
...
<p class="catalog-fact"><strong>目录身份：</strong>官方目录收录 Learning, Equity, and Problem Solving for the Public Good (LEAPS)（本科项目（学位名称尚未核实））。本轮尚未完成该独立项目课程、费用及毕业去向的逐项核对；学校通用规则另列。</p>
...
<div class="catalog-source" id="source-p-USBENR-fc23bbf18aa15f"><div><a href="https://admissions.umich.edu/academics-majors/majors-degrees">Learning, Equity, and Problem Solving for the Public Good (LEAPS) — 官方本科目录 ↗</a><p>专业名称与目录入口；本轮未取得独立课程完整详情</p><small>核验 2026-09-12</small></div></div>
