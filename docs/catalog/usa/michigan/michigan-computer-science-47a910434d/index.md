...
<nav class="catalog-crumbs" aria-label="浏览路径"><a class="" href="/study-abroad-handbook/">大学与专业</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/">美国</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/michigan/">密歇根大学安娜堡分校</a> <span aria-hidden="true">/</span> <span aria-current="page">计算机科学（LSA）</span></nav>
...
<div class="program-at-a-glance"><div><span>入学年度</span><strong>当前课程目录；2027申请与具体阶段见正文</strong></div><div><span>学制</span><strong>尚未核实</strong></div><div><span>国际生学费</span><strong>2026/27参考USD33,301／37,612每完整学期</strong></div></div>
...
<p class="catalog-fact"><strong>课程与学习内容：</strong>以算法、计算机组成、计算理论、概率统计及毕业设计或论文建立计算基础；至少26高阶主修学分，另有规定的技术选修要求。</p>
<p class="fact-sources"><a href="#source-p-michigan-lsa-directory">官方依据</a> · <a href="#source-p-michigan-lsa-requirements-021">官方依据</a></p>

<p class="catalog-fact"><strong>规则年份与适用范围：</strong>现行公开LSA页面；Effective Winter 2026。这是主修培养规则的生效时间，不是高中申请批次或入学保证。</p>
<p class="fact-sources"><a href="#source-p-michigan-lsa-requirements-021">官方依据</a></p>

## 入学条件 {#admissions}

<p class="catalog-fact"><strong>在校先修与主修准入：</strong>以下是大学课程及在校主修要求，不是中国高中选科或高考分数条件。当前页面标注Winter2026规则：全部相关要求至少C；申报前完成EECS203或指定数学替代、EECS280及一门认可数学课，第二门数学先修可申报后完成。这些是在校主修准入条件；本页未载新生advance selection规则，不能据此认定2027新生需预选。</p>
<p class="fact-sources"><a href="#source-p-michigan-lsa-requirements-021">官方依据</a></p>
...
<p class="catalog-fact"><strong>对应学院国际生学费：</strong>2026—2027、Michigan Non-Resident、每完整学期12—18学分：低年级USD33,301、高年级USD37,612。高低年级依计入学位的累计学分0—54／55+划分；不是学年价。另缴费用及保险见学校共用费用。2027—2028价格未确认。</p>
...
- [官方项目页面或项目所在目录](https://lsa.umich.edu/lsa/academics/majors-minors/computer-science-major.html)
...
<div class="catalog-source" id="source-p-michigan-lsa-requirements-021"><div><a href="https://lsa.umich.edu/lsa/academics/majors-minors/computer-science-major.html">Computer Science (Major) — 当前公开主修要求 ↗</a><p>课程结构、大学先修、在校申报及成绩规则；适用时间以正文生效标注为准</p><small>核验 2026-09-13</small></div></div>
