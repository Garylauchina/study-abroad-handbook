...
<p class="fact-sources"><a href="#source-p-USBENR-04ffa561f854d9">官方依据</a></p>

<p class="catalog-fact"><strong>课程表举例：</strong>目录所列课程包括：Intro To Programming &amp; Problem Solving；Data Structures and Algorithms；Object Oriented Programming；Introduction to Computer Science；Computer Architecture and Organization；Intro to Operating Systm。这是课程表的部分例子，可能含选修或备选项；不构成全部必修清单。</p>
<p class="fact-sources"><a href="#source-p-USBENR-04ffa561f854d9">官方依据</a></p>
...
- [官方项目页面或项目所在目录](https://bulletins.nyu.edu/undergraduate/engineering/programs/computer-science-bs/)
- [官方目录](https://bulletins.nyu.edu/programs/)

<div class="catalog-source" id="source-p-USBENR-04ffa561f854d9"><div><a href="https://bulletins.nyu.edu/undergraduate/engineering/programs/computer-science-bs/">Computer Science — 官方本科课程目录 ↗</a><p>目录学位身份、课程表及局部学分、入学后专业申报/进阶条件、职业方向与特殊入学路径</p><small>核验 2026-09-12</small></div></div>
