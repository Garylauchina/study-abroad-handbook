---
title: "纽约大学 · Integrated Design and Media"
...
<nav class="catalog-crumbs" aria-label="浏览路径"><a class="" href="/study-abroad-handbook/">大学与专业</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/">美国</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/nyu/">纽约大学</a> <span aria-hidden="true">/</span> <span aria-current="page">Integrated Design and Media</span></nav>

<p class="catalog-eyebrow">纽约大学 · 本科 · 艺术与设计</p>

# Integrated Design and Media

<p class="program-title-en">Integrated Design and Media</p>
...
<p><strong>官方名称：</strong>Integrated Design and Media</p>
...
<p class="fact-sources"><a href="#source-p-USBENR-fc9e05976ce997">官方依据</a></p>

<p class="catalog-fact"><strong>课程表举例：</strong>目录所列课程包括：Audio Foundation Studio；Visual Foundation Studio；Creative Coding；Ideation &amp; Prototyping；Intro to Web Development；Still and Moving Images。这是课程表的部分例子，可能含选修或备选项；不构成全部必修清单。</p>
<p class="fact-sources"><a href="#source-p-USBENR-fc9e05976ce997">官方依据</a></p>
...
- [官方项目页面或项目所在目录](https://bulletins.nyu.edu/undergraduate/engineering/programs/integrated-design-media-bs/)
- [官方目录](https://bulletins.nyu.edu/programs/)

<div class="catalog-source" id="source-p-USBENR-fc9e05976ce997"><div><a href="https://bulletins.nyu.edu/undergraduate/engineering/programs/integrated-design-media-bs/">Integrated Design and Media — 官方本科课程目录 ↗</a><p>目录学位身份、课程表及局部学分、入学后专业申报/进阶条件、职业方向与特殊入学路径</p><small>核验 2026-09-12</small></div></div>
