---
title: "纽约大学 · Data Science and Mathematics"
...
<nav class="catalog-crumbs" aria-label="浏览路径"><a class="" href="/study-abroad-handbook/">大学与专业</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/">美国</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/nyu/">纽约大学</a> <span aria-hidden="true">/</span> <span aria-current="page">Data Science and Mathematics</span></nav>

<p class="catalog-eyebrow">纽约大学 · 本科 · 计算机</p>

# Data Science and Mathematics

<p class="program-title-en">Data Science and Mathematics</p>
...
<p><strong>官方名称：</strong>Data Science and Mathematics</p>
...
<p class="fact-sources"><a href="#source-p-USBENR-6e4c2b1d075883">官方依据</a></p>

<p class="catalog-fact"><strong>课程表举例：</strong>目录所列课程包括：Writing as Inquiry；Principles of Data Science I；Principles of Data Science II；Causal Inference；Responsible Data Science；Discrete Mathematics。这是课程表的部分例子，可能含选修或备选项；不构成全部必修清单。</p>
<p class="fact-sources"><a href="#source-p-USBENR-6e4c2b1d075883">官方依据</a></p>
...
- [官方项目页面或项目所在目录](https://bulletins.nyu.edu/undergraduate/arts-science/programs/data-science-mathematics-ba/)
- [官方目录](https://bulletins.nyu.edu/programs/)

<div class="catalog-source" id="source-p-USBENR-6e4c2b1d075883"><div><a href="https://bulletins.nyu.edu/undergraduate/arts-science/programs/data-science-mathematics-ba/">Data Science and Mathematics — 官方本科课程目录 ↗</a><p>目录学位身份、课程表及局部学分、入学后专业申报/进阶条件、职业方向与特殊入学路径</p><small>核验 2026-09-12</small></div></div>
