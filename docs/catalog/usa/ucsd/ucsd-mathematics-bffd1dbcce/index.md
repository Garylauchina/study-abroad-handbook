...
<nav class="catalog-crumbs" aria-label="浏览路径"><a class="" href="/study-abroad-handbook/">大学与专业</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/">美国</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/ucsd/">加利福尼亚大学圣迭戈分校</a> <span aria-hidden="true">/</span> <span aria-current="page">数学</span></nav>
...
<p class="catalog-fact"><strong>专业课程结构：</strong>在微积分与线性代数基础后，修 13 门高阶课、52 units：数学推理、实分析、抽象/应用代数及数学选修。拟读数学研究生者，官网推荐较完整的 140A/B/C 与 100A/B/C 序列；推荐不等同统一硬性必修。</p>
...
<div class="catalog-source" id="source-p-UCSCR-e5fc9361d8b78e77"><div><a href="https://catalog.ucsd.edu/curric/MATH-ug.html">UC San Diego 官方课程目录：Mathematics ↗</a><p>专业课程结构</p><small>核验 2026-09-13</small></div></div>
