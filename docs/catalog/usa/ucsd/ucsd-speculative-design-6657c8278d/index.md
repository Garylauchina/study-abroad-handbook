...
<nav class="catalog-crumbs" aria-label="浏览路径"><a class="" href="/study-abroad-handbook/">大学与专业</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/">美国</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/ucsd/">加利福尼亚大学圣迭戈分校</a> <span aria-hidden="true">/</span> <span aria-current="page">思辨设计</span></nav>

<p class="catalog-eyebrow">加利福尼亚大学圣迭戈分校 · 本科 · 艺术与设计</p>

# 思辨设计

<p class="program-title-en">Speculative Design</p>
...
<p><strong>官方名称：</strong>Speculative Design</p>
...
<p class="catalog-fact"><strong>专业课程结构：</strong>基础六门含视觉文化、思辨设计与设计传播；高阶必修 VIS 135 协作研究方法，按目录选择中阶讲座/工作室、两门史论及三门进阶选修。</p>
<p class="fact-sources"><a href="#source-p-UCSCR-9ae485e174d28ab5">官方依据</a></p>

<p class="catalog-fact"><strong>课程与学分补充：</strong>主题结合艺术、科学、新技术、城市和社会情境，以实验及田野研究生成设计；终结课程 VIS 190 Design Master Studio 为一门 8 units 的本科工作室，名称中的 Master 不代表授予硕士学位。中阶与进阶课程不得重复计入。</p>
<p class="fact-sources"><a href="#source-p-UCSCR-9ae485e174d28ab5">官方依据</a></p>
...
- [官方项目页面或项目所在目录](http://visarts.ucsd.edu/)
