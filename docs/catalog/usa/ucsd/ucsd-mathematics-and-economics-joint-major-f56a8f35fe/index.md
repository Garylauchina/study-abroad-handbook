...
<nav class="catalog-crumbs" aria-label="浏览路径"><a class="" href="/study-abroad-handbook/">大学与专业</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/">美国</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/ucsd/">加利福尼亚大学圣迭戈分校</a> <span aria-hidden="true">/</span> <span aria-current="page">数学与经济学联合主修</span></nav>

<p class="catalog-eyebrow">加利福尼亚大学圣迭戈分校 · 本科 · 经济</p>

# 数学与经济学联合主修

<p class="program-title-en">Mathematics and Economics - Joint Major</p>
...
<p><strong>官方名称：</strong>Mathematics and Economics - Joint Major</p>
...
<p class="catalog-fact"><strong>专业课程结构：</strong>低年级数学与 ECON 1/3 衔接到 15 门高阶课、60 units，数学和经济各至少七门；包含分析/代数、微观经济、计量统计，以及宏观、优化或运筹等组合。</p>
<p class="fact-sources"><a href="#source-p-UCSCR-e5fc9361d8b78e77">官方依据</a></p>

<p class="catalog-fact"><strong>课程与学分补充：</strong>这是一个联合主修，不是两个独立学位；不能与数学系或经济系其他主修双修，也不能再辅修数学或经济。</p>
<p class="fact-sources"><a href="#source-p-UCSCR-e5fc9361d8b78e77">官方依据</a></p>
...
<p class="catalog-fact"><strong>学科校友去向：数学：</strong>学校在数学学科介绍中列出本学科或相近专业的近期校友调查例子，以下并非仅限本条具体学位或方向。就业领域/岗位例子：软件开发与质量测试人员、研究助理、管理顾问与商业分析师。继续深造领域例子：计算机科学、金融数学、统计学。雇主例子：Amazon、University of California、Google。该页未提供具体届次、样本人数或中国学生分组，不能计算本专业就业率或薪酬；出现医学、法律、教学等职业或深造领域，不等于完成本本科即可取得相应执业资格。</p>
<p class="fact-sources"><a href="#source-p-ucsd-alumni-mathematics">官方依据</a></p>
...
<div class="catalog-source" id="source-p-UCSCR-e5fc9361d8b78e77"><div><a href="https://catalog.ucsd.edu/curric/MATH-ug.html">UC San Diego 官方课程目录：Mathematics ↗</a><p>专业课程结构；课程与学分补充</p><small>核验 2026-09-13</small></div></div>
...
<div class="catalog-source" id="source-p-ucsd-alumni-mathematics"><div><a href="https://majors.ucsd.edu/academic-schools/physical-sciences/mathematics/index.html">UCSD Mathematics：校友就业与深造案例 ↗</a><p>公开What can I do with this major栏目；本学科或相近专业校友案例，非本条具体项目统计</p><small>核验 2026-09-13</small></div></div>
