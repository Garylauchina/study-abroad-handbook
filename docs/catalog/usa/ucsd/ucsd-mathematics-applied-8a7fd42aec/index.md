...
<nav class="catalog-crumbs" aria-label="浏览路径"><a class="" href="/study-abroad-handbook/">大学与专业</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/">美国</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/ucsd/">加利福尼亚大学圣迭戈分校</a> <span aria-hidden="true">/</span> <span aria-current="page">应用数学</span></nav>

<p class="catalog-eyebrow">加利福尼亚大学圣迭戈分校 · 本科 · 数学与统计</p>

# 应用数学

<p class="program-title-en">Mathematics (Applied)</p>
...
<p><strong>官方名称：</strong>Mathematics (Applied)</p>
...
<p class="catalog-fact"><strong>专业课程结构：</strong>基础含微积分、线性代数与编程；高年级 13 门、52 units，含数学推理、线性代数、分析、概率/统计，再从组合、微分方程、数值、优化、概率或统计中选两套序列。</p>
<p class="fact-sources"><a href="#source-p-UCSCR-e5fc9361d8b78e77">官方依据</a></p>

<p class="catalog-fact"><strong>课程与学分补充：</strong>最多三门高阶课、12 units 可经批准来自其他院系的应用数学领域；不能用任意外系课替代。</p>
<p class="fact-sources"><a href="#source-p-UCSCR-e5fc9361d8b78e77">官方依据</a></p>
