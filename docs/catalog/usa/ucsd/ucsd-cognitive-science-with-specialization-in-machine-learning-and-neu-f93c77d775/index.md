---
title: "加利福尼亚大学圣迭戈分校 · 认知科学（机器学习与神经计算方向）"
...
<nav class="catalog-crumbs" aria-label="浏览路径"><a class="" href="/study-abroad-handbook/">大学与专业</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/">美国</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/ucsd/">加利福尼亚大学圣迭戈分校</a> <span aria-hidden="true">/</span> <span aria-current="page">认知科学（机器学习与神经计算方向）</span></nav>

<p class="catalog-eyebrow">加利福尼亚大学圣迭戈分校 · 本科 · 待分类</p>

# 认知科学（机器学习与神经计算方向）

<p class="program-title-en">Cognitive Science with Specialization in Machine Learning and Neural Computation</p>
...
<p><strong>官方名称：</strong>Cognitive Science with Specialization in Machine Learning and Neural Computation</p>
...
<p class="catalog-fact"><strong>专业课程结构：</strong>CG35 以认知系统的数学计算建模、理论神经科学和神经网络/AI 为重点；选修中须从 COGS 118A/B/C/D 再选两门，不能只选任意计算机课程代替。</p>
<p class="fact-sources"><a href="#source-p-UCSCR-bf2f14a9aed9b14a">官方依据</a></p>

<p class="catalog-fact"><strong>方向与课程适用范围：</strong>具名方向仍须满足认知科学 BS 全部核心：低年级按数学路线为 40 或 44 units，高阶为 48 units；六门高阶选修中四门须来自该方向认可清单，且不保证每门每年开课。</p>
<p class="fact-sources"><a href="#source-p-UCSCR-bf2f14a9aed9b14a">官方依据</a></p>
...
<div class="catalog-source" id="source-p-UCSCR-bf2f14a9aed9b14a"><div><a href="https://catalog.ucsd.edu/curric/COGS-ug.html">UC San Diego 官方课程目录：Cognitive Science ↗</a><p>专业课程结构；方向与课程适用范围</p><small>核验 2026-09-13</small></div></div>
