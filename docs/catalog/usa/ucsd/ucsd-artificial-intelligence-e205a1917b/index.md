...
<nav class="catalog-crumbs" aria-label="浏览路径"><a class="" href="/study-abroad-handbook/">大学与专业</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/">美国</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/ucsd/">加利福尼亚大学圣迭戈分校</a> <span aria-hidden="true">/</span> <span aria-current="page">人工智能</span></nav>
...
<p class="catalog-fact"><strong>专业课程结构：</strong>专业要求 124 units，不含书院通识：低年级 60、高年级 64。基础含编程、离散数学、线性代数、微积分、概率统计及 CSE 25/55。</p>
<p class="fact-sources"><a href="#source-p-UCSCR-d83271a10a53fe78">官方依据</a></p>

<p class="catalog-fact"><strong>课程与学分补充：</strong>高年级包含数据结构、算法、人工智能与机器学习核心 16 units；另修伦理 4、AI 选修 12 和 CSE 选修 32 units，选修须覆盖系统、理论/抽象和计算应用。</p>
<p class="fact-sources"><a href="#source-p-UCSCR-d83271a10a53fe78">官方依据</a></p>
...
<p class="catalog-fact"><strong>学科校友去向：计算机科学与工程：</strong>这是相关成熟学科的校友例子，不是新设人工智能专业已经产生的毕业调查。学校在计算机科学与工程学科介绍中列出本学科或相近专业的近期校友调查例子，以下并非仅限本条具体学位或方向。就业领域/岗位例子：软件开发与质量测试人员、辅导教师、教师与讲师、全栈软件工程师。继续深造领域例子：计算机科学、计算机与信息科学、信息技术。雇主例子：Amazon、Google、University of California。该页未提供具体届次、样本人数或中国学生分组，不能计算本专业就业率或薪酬；出现医学、法律、教学等职业或深造领域，不等于完成本本科即可取得相应执业资格。</p>
