...
<nav class="catalog-crumbs" aria-label="浏览路径"><a class="" href="/study-abroad-handbook/">大学与专业</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/">美国</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/ucsd/">加利福尼亚大学圣迭戈分校</a> <span aria-hidden="true">/</span> <span aria-current="page">数学与计算机科学</span></nav>
...
<p class="catalog-fact"><strong>专业课程结构：</strong>此学位设在数学系，培养计算机科学的数学基础；高阶 14 门、56 units，含代数、可计算性、数据结构、概率、组合/离散数学、算法及计算选修。</p>
<p class="fact-sources"><a href="#source-p-UCSCR-e5fc9361d8b78e77">官方依据</a></p>

<p class="catalog-fact"><strong>课程与学分补充：</strong>同一门课不得重复满足多个主修要求；不能再辅修 CSE 计算机科学，修 CSE 课程仍受其选课限制，不因数学系主修自动保证名额。</p>
<p class="fact-sources"><a href="#source-p-UCSCR-e5fc9361d8b78e77">官方依据</a></p>
...
- [官方项目页面或项目所在目录](http://math.ucsd.edu/)
