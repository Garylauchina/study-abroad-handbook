...
<nav class="catalog-crumbs" aria-label="浏览路径"><a class="" href="/study-abroad-handbook/">大学与专业</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/">美国</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/ucsd/">加利福尼亚大学圣迭戈分校</a> <span aria-hidden="true">/</span> <span aria-current="page">数据科学</span></nav>
...
<p class="catalog-fact"><strong>专业课程结构：</strong>专业合计 112 units：低年级 52、高年级 60；基础为数学 16、数据科学 28、应用领域 8 units。高阶核心 32、毕业项目 DSC 180A/B 共 8、选修 20 units。</p>
<p class="fact-sources"><a href="#source-p-UCSCR-7a21cfc108f40bf3">官方依据</a></p>

<p class="catalog-fact"><strong>课程与学分补充：</strong>内容衔接预测建模、统计分析、编程、数据管理及应用领域知识；可选商业经济、机器学习、生命科学或社会科学领域，但不能把这些选课领域等同于新商业数据科学 BS。</p>
<p class="fact-sources"><a href="#source-p-UCSCR-7a21cfc108f40bf3">官方依据</a></p>
...
<p class="catalog-fact"><strong>学科校友去向：数据科学：</strong>学校在数据科学学科介绍中列出本学科或相近专业的近期校友调查例子，以下并非仅限本条具体学位或方向。就业领域/岗位例子：数据科学家、软件开发与质量测试人员、研究助理。继续深造领域例子：计算机科学、管理科学与定量方法、运筹学。雇主例子：Amazon、Meta、Deloitte。该页未提供具体届次、样本人数或中国学生分组，不能计算本专业就业率或薪酬；出现医学、法律、教学等职业或深造领域，不等于完成本本科即可取得相应执业资格。</p>
...
- [官方项目页面或项目所在目录](https://datascience.ucsd.edu/academics/undergraduate/)
- [官方目录](https://students.ucsd.edu/academics/advising/majors-minors/undergraduate-majors.html)

<div class="catalog-source" id="source-p-UCSCR-7a21cfc108f40bf3"><div><a href="https://catalog.ucsd.edu/curric/DSC-ug.html">UC San Diego 官方课程目录：Data Science ↗</a><p>专业课程结构；课程与学分补充</p><small>核验 2026-09-13</small></div></div>
