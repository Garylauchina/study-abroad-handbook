...
<p class="catalog-fact"><strong>介绍中的学习主题：</strong>本项目官方介绍涉及建筑、历史。这是介绍中的主题摘要，不能代替必修课清单、完整培养方案或专业入学条件。</p>
<p class="fact-sources"><a href="#source-p-columbia-program-ff7a5af25dd3bd1a">官方依据</a></p>

<p class="catalog-fact"><strong>具体学习单元示例：</strong>本科培养表列出的单元：ARCHITECTURAL DESIGN: SYSTEMS AND MATERIALS（ARCH UN2101）；ARCHITECTURAL DESIGN: ENVIRONMENTS AND MEDIATIONS（ARCH UN2103）。示例不代表全部必修或当年保证开课，需核对必修/选修与授课安排。</p>
<p class="fact-sources"><a href="#source-p-columbia-program-ff7a5af25dd3bd1a">官方依据</a></p>
...
- [官方项目页面或项目所在目录](https://bulletin.columbia.edu/general-studies/majors-concentrations/architecture/)
- [官方目录](https://bulletin.columbia.edu/general-studies/majors-concentrations/)

<div class="catalog-source" id="source-p-columbia-program-ff7a5af25dd3bd1a"><div><a href="https://bulletin.columbia.edu/general-studies/majors-concentrations/architecture/">Architecture 官方培养资料 ↗</a><p>本条培养表、具体学习单元及资料范围</p><small>核验 2026-09-12</small></div></div>
