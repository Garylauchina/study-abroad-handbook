...
<p class="fact-sources"><a href="#source-p-USBENR-c04fadda5e9ea4">官方依据</a></p>
...
<p class="catalog-fact"><strong>课程代码举例：</strong>学术要求涉及BIOLOGY 202L、BIOLOGY 203L、EVANTH 101等课程。代码用于定位官方目录；可能含必修、备选或建议项，本轮未把它们统一归为必修。</p>
<p class="fact-sources"><a href="#source-p-USBENR-c04fadda5e9ea4">官方依据</a></p>
...
- [官方项目页面或项目所在目录](https://undergraduate.bulletins.duke.edu/pages/9kNjSpnyQ8hZzIMEhcLK)
- [官方目录](https://undergraduate.bulletins.duke.edu/allprograms/all)

<div class="catalog-source" id="source-p-USBENR-c04fadda5e9ea4"><div><a href="https://undergraduate.bulletins.duke.edu/pages/9kNjSpnyQ8hZzIMEhcLK">Evolutionary Anthropology — 官方本科课程目录 ↗</a><p>目录学位身份、课程表及局部学分、入学后专业申报/进阶条件、职业方向与特殊入学路径</p><small>核验 2026-09-12</small></div></div>
