...
<p class="fact-sources"><a href="#source-p-USBENR-3c2b409f951d3f">官方依据</a></p>

<p class="catalog-fact"><strong>本科毕业最低学分：</strong>该页载明取得学位至少需要34个 Duke units；这里的 units 不是其他大学的学分换算。</p>
<p class="fact-sources"><a href="#source-p-USBENR-3c2b409f951d3f">官方依据</a></p>

<p class="catalog-fact"><strong>主修要求最低学分：</strong>主修部分至少18个 Duke units；页面若另列共同先修（co-requisites），仍须额外满足，不以此数字代表全部本科课程。</p>
<p class="fact-sources"><a href="#source-p-USBENR-3c2b409f951d3f">官方依据</a></p>

<p class="catalog-fact"><strong>课程代码举例：</strong>学术要求涉及CHEM 101DL、MATH 122L、MATH 212、MATH 216、MATH 221、MATH 356等课程。代码用于定位官方目录；可能含必修、备选或建议项，本轮未把它们统一归为必修。</p>
<p class="fact-sources"><a href="#source-p-USBENR-3c2b409f951d3f">官方依据</a></p>
...
- [官方项目页面或项目所在目录](https://undergraduate.bulletins.duke.edu/pages/ZW4BaEE0YaGc2s3BgaSN)
- [官方目录](https://undergraduate.bulletins.duke.edu/allprograms/all)

<div class="catalog-source" id="source-p-USBENR-3c2b409f951d3f"><div><a href="https://undergraduate.bulletins.duke.edu/pages/ZW4BaEE0YaGc2s3BgaSN">Biophysics — 官方本科课程目录 ↗</a><p>目录学位身份、课程表及局部学分、入学后专业申报/进阶条件、职业方向与特殊入学路径</p><small>核验 2026-09-12</small></div></div>
