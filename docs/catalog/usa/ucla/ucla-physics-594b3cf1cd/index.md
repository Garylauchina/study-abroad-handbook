...
<p class="catalog-fact"><strong>目录身份：</strong>官方目录收录 Physics（BA）。本轮尚未完成该独立项目课程、费用及毕业去向的逐项核对；学校通用规则另列。</p>
...
- [官方项目页面或项目所在目录](https://newstudents.ucla.edu/studyarea/?type=MAJ&code=285)
