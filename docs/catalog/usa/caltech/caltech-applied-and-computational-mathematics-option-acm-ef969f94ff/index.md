---
title: "加州理工学院 · Applied and Computational Mathematics Option (ACM)"
...
<nav class="catalog-crumbs" aria-label="浏览路径"><a class="" href="/study-abroad-handbook/">大学与专业</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/">美国</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/caltech/">加州理工学院</a> <span aria-hidden="true">/</span> <span aria-current="page">Applied and Computational Mathematics Option (ACM)</span></nav>

<p class="catalog-eyebrow">加州理工学院 · 本科 · 数学与统计</p>

# Applied and Computational Mathematics Option (ACM)

<p class="program-title-en">Applied and Computational Mathematics Option (ACM)</p>
...
<p><strong>官方名称：</strong>Applied and Computational Mathematics Option (ACM)</p>

<p><strong>授予学位 / 项目类型：</strong>Bachelor of Science</p>

<p><strong>目录适用期：</strong>2025-2026</p>

<p class="catalog-fact"><strong>学习内容：</strong>将数学基础与实际问题结合，学习计算与应用数学，并在某个应用领域训练研究能力；应用例有流体、材料、数学生物、图像处理和金融。</p>
<p class="fact-sources"><a href="#source-p-caltech-program-applied-and-computational-mathematics-acm">官方依据</a></p>
...
- [官方项目页面或项目所在目录](https://www.catalog.caltech.edu/current/information-for-undergraduate-students/graduation-requirements-all-options/applied-and-computational-mathematics-acm/)
- [官方目录](https://www.catalog.caltech.edu/current/information-for-undergraduate-students/graduation-requirements-all-options/)

<div class="catalog-source" id="source-p-caltech-program-applied-and-computational-mathematics-acm"><div><a href="https://www.catalog.caltech.edu/current/information-for-undergraduate-students/graduation-requirements-all-options/applied-and-computational-mathematics-acm/">Applied and Computational Mathematics Option (ACM) 官方专业资料 ↗</a><p>本条学习内容、培养结构、内部要求及本轮核验边界</p><small>核验 2026-09-12</small></div></div>
