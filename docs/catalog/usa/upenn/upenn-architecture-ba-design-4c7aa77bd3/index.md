---
title: "宾夕法尼亚大学 · Architecture, BA: Design"
...
<p><strong>官方名称：</strong>Architecture, BA: Design</p>
...
<p class="fact-sources"><a href="#source-p-upenn-program-undergraduate-programs-architecture-design-ba">官方依据</a></p>
...
- [官方项目页面或项目所在目录](https://catalog.upenn.edu/undergraduate/programs/architecture-design-ba/)
- [官方目录](https://catalog.upenn.edu/undergraduate/programs/)

<div class="catalog-source" id="source-p-upenn-program-undergraduate-programs-architecture-design-ba"><div><a href="https://catalog.upenn.edu/undergraduate/programs/architecture-design-ba/">Architecture, BA: Design 官方专业资料 ↗</a><p>本条学习内容、培养结构、内部要求及本轮核验边界</p><small>核验 2026-09-12</small></div></div>
