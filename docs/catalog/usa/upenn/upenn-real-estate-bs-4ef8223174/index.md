...
<p><strong>官方名称：</strong>Real Estate, BS</p>
...
<p class="fact-sources"><a href="#source-p-upenn-program-undergraduate-programs-real-estate-bs">官方依据</a></p>

<p class="catalog-fact"><strong>具体学习单元示例：</strong>本条培养表列出：Real Estate Investment: Analysis and Financing 1（REAL/FNCE 2090）；Real Estate Law（REAL/LGST 2040）。需按原表区分必修、选修及替代选项。</p>
<p class="fact-sources"><a href="#source-p-upenn-program-undergraduate-programs-real-estate-bs">官方依据</a></p>
...
- [官方项目页面或项目所在目录](https://catalog.upenn.edu/undergraduate/programs/real-estate-bs/)
- [官方目录](https://catalog.upenn.edu/undergraduate/programs/)

<div class="catalog-source" id="source-p-upenn-program-undergraduate-programs-real-estate-bs"><div><a href="https://catalog.upenn.edu/undergraduate/programs/real-estate-bs/">Real Estate, BS 官方专业资料 ↗</a><p>本条学习内容、培养结构、内部要求及本轮核验边界</p><small>核验 2026-09-12</small></div></div>
