---
title: "宾夕法尼亚大学 · Computer Science, BSE"
...
<p><strong>官方名称：</strong>Computer Science, BSE</p>
...
<p class="catalog-fact"><strong>培养结构表的学分：</strong>选取本专业/方向培养表最后列出的合计为5 course units。该合计可能是主修或方向表，不能自动当作整个学士学位的毕业总量，也不与通识要求直接相加。</p>
<p class="fact-sources"><a href="#source-p-upenn-program-undergraduate-programs-computer-science-bse">官方依据</a></p>

<p class="catalog-fact"><strong>具体学习单元示例：</strong>本条培养表列出：Introduction to Artificial Intelligence（CIS 2210）；Artificial Intelligence（or CIS 5210）。需按原表区分必修、选修及替代选项。</p>
<p class="fact-sources"><a href="#source-p-upenn-program-undergraduate-programs-computer-science-bse">官方依据</a></p>
...
- [官方项目页面或项目所在目录](https://catalog.upenn.edu/undergraduate/programs/computer-science-bse/)
- [官方目录](https://catalog.upenn.edu/undergraduate/programs/)

<div class="catalog-source" id="source-p-upenn-program-undergraduate-programs-computer-science-bse"><div><a href="https://catalog.upenn.edu/undergraduate/programs/computer-science-bse/">Computer Science, BSE 官方专业资料 ↗</a><p>本条学习内容、培养结构、内部要求及本轮核验边界</p><small>核验 2026-09-12</small></div></div>
