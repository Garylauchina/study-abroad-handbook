---
title: "宾夕法尼亚大学 · Visual and Interactive Computing, BSE"
...
<p><strong>官方名称：</strong>Visual and Interactive Computing, BSE</p>
...
<p class="fact-sources"><a href="#source-p-upenn-program-undergraduate-programs-visual-interactive-computing-bse">官方依据</a></p>

<p class="catalog-fact"><strong>具体学习单元示例：</strong>本条培养表列出：计算机编程导论（CIS 1100）；Programming Languages and Techniques I（CIS 1200）。需按原表区分必修、选修及替代选项。</p>
<p class="fact-sources"><a href="#source-p-upenn-program-undergraduate-programs-visual-interactive-computing-bse">官方依据</a></p>
...
- [官方项目页面或项目所在目录](https://catalog.upenn.edu/undergraduate/programs/visual-interactive-computing-bse/)
- [官方目录](https://catalog.upenn.edu/undergraduate/programs/)

<div class="catalog-source" id="source-p-upenn-program-undergraduate-programs-visual-interactive-computing-bse"><div><a href="https://catalog.upenn.edu/undergraduate/programs/visual-interactive-computing-bse/">Visual and Interactive Computing, BSE 官方专业资料 ↗</a><p>本条学习内容、培养结构、内部要求及本轮核验边界</p><small>核验 2026-09-12</small></div></div>
