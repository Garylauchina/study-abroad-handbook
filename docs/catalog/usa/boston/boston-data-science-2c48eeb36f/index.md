...
<nav class="catalog-crumbs" aria-label="浏览路径"><a class="" href="/study-abroad-handbook/">大学与专业</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/">美国</a> <span aria-hidden="true">/</span> <a class="" href="/study-abroad-handbook/catalog/usa/boston/">波士顿大学</a> <span aria-hidden="true">/</span> <span aria-current="page">数据科学</span></nav>
...
<p><strong>申请路径：</strong>主修课程须达 C；高级选修可按方法论或应用领域两类组织，须满足其中一路径三个类别并加一门选修</p>

<p class="catalog-fact"><strong>学位与课程结构：</strong>BS 主修至少 16 门课，含数据科学与数学基础、编程、数据处理、统计、算法、机器学习及伦理，四门高级选修、至少四学分受指导项目，以及另外四学分 CDS 课程。</p>
<p class="fact-sources"><a href="#source-p-BU-6a329b7093cfd934">官方依据</a></p>

## 入学条件 {#admissions}

<p class="catalog-fact"><strong>专业入口与大学阶段规则：</strong>主修课程须达 C；高级选修可按方法论或应用领域两类组织，须满足其中一路径三个类别并加一门选修。两类是本主修的课程组织方向，不能视为两个独立学位；毕业项目可通过实习实践课或指导研究完成。</p>
<p class="fact-sources"><a href="#source-p-BU-6a329b7093cfd934">官方依据</a></p>
...
- [官方项目页面或项目所在目录](https://www.bu.edu/academics/cds/programs/bs-in-data-science/)
...
<div class="catalog-source" id="source-p-BU-6a329b7093cfd934"><div><a href="https://www.bu.edu/academics/cds/programs/bs-in-data-science/">BS in Data Science — BU 官方课程目录 ↗</a><p>本项目学位、课程与学分、大学阶段先修和进阶、授课语言或停招状态；当前页面不自动等于下一届课程保证</p><small>核验 2026-09-13</small></div></div>
