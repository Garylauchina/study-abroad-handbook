...
<p><strong>申请路径：</strong>按所属学位入读及内部选主修；代码 MAJ03515</p>

<p class="catalog-fact"><strong>课程内容与路径：</strong>学位内工程主修，学习数据采集、存储、转换和交付，涵盖数据仓库、提取—转换—加载（ETL）、分布式系统与机器学习，并关注数据质量、安全性和可靠性。</p>
<p class="fact-sources"><a href="#source-p-uts-handbook-maj03515">官方依据</a></p>
...
- [官方项目页面或项目所在目录](https://coursehandbook.uts.edu.au/aos/2027/MAJ03515)
- [官方目录](https://coursehandbook.uts.edu.au/search?ct=aos)

<div class="catalog-source" id="source-p-uts-handbook-maj03515"><div><a href="https://coursehandbook.uts.edu.au/aos/2027/MAJ03515">UTS 2027 手册：Data Science Engineering（MAJ03515） ↗</a><p>2027手册中的课程身份、公开说明、课程结构、Notes及侧栏学习安排；不是所有申请者的新生录取确认。</p><small>核验 2026-09-13</small></div></div>
