...
<p class="catalog-fact"><strong>学习单元示例：</strong>课程结构/课程页列例如：A Sociological Orientation to Education；Early Years Curriculum and Pedagogical Foundations。示例可含选修或替代选项，不表示每一项均为所有学生必修。</p>
<p class="fact-sources"><a href="#source-p-queensland-detail-bachelor-education-primary-honours-2380">官方依据</a></p>
...
<p class="catalog-fact"><strong>官网列出的职业方向：</strong>可探索的岗位例如：Higher education compliance manager、Director of studies、Learning designer。方向取决于所选主修和进一步资格，不是就业率或雇主承诺。</p>
<p class="fact-sources"><a href="#source-p-queensland-detail-bachelor-education-primary-honours-2380">官方依据</a></p>
